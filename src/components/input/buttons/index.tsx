...
export const IconButton = ({ src, alt, className, ...props }: {
    src: string;
    alt: string;
    className?: string;
} & ButtonProps) => (
    <Button
    variant={"outline"} className={`flex border-none gap-2 w-fit aspect-square mb-4 relative rounded-full ${className}`}
    {...props}
    >
        <Image 
