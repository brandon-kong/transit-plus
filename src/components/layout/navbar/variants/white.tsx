...
export default function WhiteNavbar () {
    ...
    return (
        <div className={`transition-colors px-8 md:px-[80px] lg:px-[50px] flex justify-between items-center h-16 text-black w-full fixed top-0 z-10 bg-white drop-shadow-sm`} role="navigation">
