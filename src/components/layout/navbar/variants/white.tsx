...
const components: { title: string; href: string; description: string }[] = [
    {
        ...
        href: '#',
        description: 'Report the fullness of a train to help others plan their trips.',
    },
    {
        title: 'Report Train Delay',
        href: '#',
        description: 'Report the delay of a train to help others plan their trips.',
    },
    {
        title: 'Safety Concern',
        href: '/report/safety',
        description: 'Report a safety concern to help others safely plan their trips.',
    },
    {
    ...
    },
    {
        title: 'Blog',
        href: '#',
        description: 'Read about the latest news and updates from the Transit+ team.',
    },
    {
        title: 'Leaderboard',
        href: '#',
        description: ' Recognize and reward users who actively contribute to crowdsourcing.',
    },
];
...
export default function WhiteNavbar() {
    ...
    return (
        <div
            className={`transition-colors px-8 md:px-[80px] lg:px-[50px] flex justify-between items-center h-16 text-black w-full fixed top-0 z-10 bg-white drop-shadow-sm`}
            role="navigation"
        >
