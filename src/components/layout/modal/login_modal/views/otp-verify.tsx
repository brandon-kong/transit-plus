                    ...
                    <MenubarMenu>
                        <MenubarTrigger className="h-0">
                            <Button
                                ...
                                variant={'ghost'}
                                size={'lg'}
                                className={'flex gap-2 mt-4 h-12 data-[state=open]:bg-accent'}
                            >
                                Options
                                <Image src="/icons/action/down.svg" alt="Options" width={20} height={20} />
                            </Button>
                        </MenubarTrigger>
                        <MenubarContent>
                            <MenubarItem disabled={!canSendOTP} onClick={attemptPhoneSendOTP}>
                                Resend OTP {!canSendOTP && `(${secondsToResend})`}
                            </MenubarItem>
                            <MenubarItem disabled={!canSendOTP} onClick={attemptPhoneCallOTP}>
