...
export const IncidentTypes: IncidentType[] = [
    ...
    },
    {
        ...
        description: 'This includes safety hazards and dangerous situations. Examples include: slippery floors, broken glass, or any other dangerous situation.'
    },
    {
        title: 'Other',
...
const IncidentCard = ({ title, description, onClick, selected }: {
    title: string,
    description: string,
    onClick: () => void,
    selected?: boolean
