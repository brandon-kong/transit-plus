...
export default function ReportSafetyLocationView() {
    ...
    const spawnIncidentMarker = useCallback(
        (maps: any) => {
    ...
    const handleApiLoaded = (map: any, maps: any) => {
        ...
        const triangleCoords = [
            { lat: 42.073312796917, lng: -87.69083605418916 },
    ...
    return (
        <div className="flex flex-col gap-4 mt-4">
            <div className="flex justify-between">
                <TypographyH4>Where did this happen?</TypographyH4>
                ...
                <Button
                    ...
                    variant={'link'}
                    className="underline rounded-md hover:bg-accent"
                >
            ...
            {mapOrManual === 'manual' ? (
                ...
                <>
                    ...
                    <div className="h-[300px] md:h-96 w-full rounded-xl overflow-hidden relative">
                        <GoogleMapReact
                        ...
                        >
                            <UserMarker lat={userLocation?.lat || 41.88} lng={userLocation?.lng || -87.62} />
                        </GoogleMapReact>
            ...
            <DialogFooter>
                <Button onClick={() => setView('date-time')} disabled={!address.completed}>
                    Continue
                </Button>
            </DialogFooter>
        </div>
...
const UserMarker = ({ lat, lng }: { lat: number; lng: number }) => {
    return (
        <div className="h-10 w-10 translate-x-[-50%] translate-y-[-50%] relative flex items-center justify-center -z-">
            <div className="h-4 w-4 absolute z-20 rounded-full bg-blue-500" />

            <div className="h-8 w-8 z-10 absolute rounded-full bg-blue-300" />

            <div className="h-10 w-10 absolute animate-ping rounded-full bg-blue-200" />
        </div>
    );
};
