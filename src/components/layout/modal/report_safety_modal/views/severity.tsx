        ...
        <div className="flex flex-col gap-4 mt-4 w-full">
            ...
            <div className="flex w-full">
                <Button
                    ...
                    className={`w-full rounded-r-none bg-yellow-500 transition-all hover:bg-yellow-600 text-white ${
                        severity === 'Low' && 'ring-2 ring-black z-10'
                    }`}
                >
                    Low
                </Button>
                <Button
                    ...
                    className={`w-full rounded-none bg-orange-500 transition-all hover:bg-orange-600 text-white ${
                        severity === 'Medium' && 'ring-2 ring-black z-10'
                    }`}
                >
                    Medium
                </Button>
                <Button
                    ...
                    className={`w-full rounded-l-none bg-red-600 transition-all hover:bg-red-700 text-white ${
                        severity === 'High' && 'ring-2 ring-black z-10'
                    }`}
                >
                    High
                </Button>
            ...
            <ScrollArea className="max-h-[200px] md:max-h-[300px]">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 border rounded-md p-4 border-dashed">
                    ...
                    >
                        ...
                        <TypographyP className="text-gray-500 text-xs">Add a photo</TypographyP>
                    </div>
            ...
            <DialogFooter>
                <Button onClick={() => setView('incident')} variant={'ghost'}>
                    Back
                </Button>

                <Button disabled={!severity} onClick={() => setView('review')}>
                    Continue
                </Button>
            </DialogFooter>
        </div>
