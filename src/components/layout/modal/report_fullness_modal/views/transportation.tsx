    ...
    return (
        <div className="flex flex-col gap-4 mt-4">
            <div className="flex justify-between">
                <TypographyH4>What type of transportation are you taking?</TypographyH4>
            </div>
            ...
            <DialogFooter>
                <Button onClick={() => setView('destination')} variant={'ghost'}>
                    Back
                </Button>

                <Button disabled={!typeOfTransportation} onClick={() => setView('frequency')}>
                    Continue
                </Button>
            </DialogFooter>
        </div>
